...
class QuizBrain {
  ...
  final List<Question> _questionRepository = [
    Question(
  ...
  String getQuestionText() {
    return _questionRepository[_questionNumber].questionText;
  }

  bool getQuestionAnswer() {
    return _questionRepository[_questionNumber].questionAnswer;
  }

  void nextQuestion() {
    if (_questionNumber < _questionRepository.length - 1) {
      _questionNumber++;
    }
    if(_questionNumber == _questionRepository.length - 1){
      _questionNumber = 0;
